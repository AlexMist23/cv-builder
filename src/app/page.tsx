          ...
          <p className={styles.footer}>
            {targetCompany && (
              <>
                ...
                {targetCompany} for the purpose of conducting recruitment for
                the position for which I am applying. I also consent to
                processing of my personal data by {targetCompany} for the
